...
<body>
    ...
    <div>
        ...
        <dx:ASPxButton ID="ASPxButton1" runat="server" OnClick="ASPxButton1_Click" Text="Ekran Görüntüsü için tıklayın.." Theme="Aqua">
        </dx:ASPxButton>
    
        
    
    </div>
        <dx:ASPxDocumentViewer ID="ASPxDocumentViewer1" runat="server" ReportTypeName="TvListReportcs" EnableTheming="True" Theme="Aqua" AccessibilityCompliant="True" ToolbarMode="None">
